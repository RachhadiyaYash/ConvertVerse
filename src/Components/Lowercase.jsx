...
const Lowercase = () => {
  ...
  const convertToLowercase = () => {
    const textInLowercase = inputText.toLowerCase();
    setOutputText(textInLowercase);
    setIsResultVisible(!!textInLowercase); // Show result only if there is text in lowercase
  };
